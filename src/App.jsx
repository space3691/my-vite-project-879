...
import { Rocket, Star, Check } from 'lucide-react';
 ...
 * ------------------------------------------------------------------
 * You can paste your entire React component here.
...
export default function App() {
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-white p-6 font-sans">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 p-12 rounded-[3rem] text-center shadow-2xl relative overflow-hidden">
        ...
        <p className="text-slate-400 mb-8 leading-relaxed font-medium">
          Your component is loaded. Replace this text with your own code in the editor on the left!
        </p>

        <div className="space-y-3">
          <div className="flex items-center justify-center text-xs font-bold text-slate-500 uppercase tracking-widest bg-slate-950/50 py-3 rounded-xl border border-slate-800">
